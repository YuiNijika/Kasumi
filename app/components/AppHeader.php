...
<head>
    ...
    <link rel="stylesheet" href="<?php get_theme_file_url('assets/motyf.css?ver=' . get_theme_version(false)); ?>">
    <link rel="stylesheet" href="<?php get_theme_file_url('assets/nprogress.min.css?ver=' . get_theme_version(false)); ?>">
    <script>
        (function() {
